// Use the correct backend port (default is 5000 for run.py)
...
const toast = (msg, type='info') => {
  ...
  t.textContent = msg; el.appendChild(t);
...
const api = async (path, opts={}) => {
  try {
    ...
    console.error(e);
    toast('API Error: Failed to connect to backend. Please check if the backend is running on port 5001.', 'danger');
    return null;
  }
};
